...
#define I2C_ADDRESS_M1     0x0D
//#define I2C_ADDRESS_M2     0x5B
//#define I2C_ADDRESS_M3     0x5C
...
void SetupSerial()
{
  ...
  serialMotor1.WriteI2cAddress(I2C_ADDRESS_M1);
...
void NewMotorTest()
{
  Serial.println("WriteMaxSpeed");
      m1->WriteMaxSpeed(255);
        Serial.println("WriteDamping");
  m1->WriteDamping(255);
    Serial.println("WriteSpeed");
  m1->WriteSpeed(255);
  Serial.println();
  Serial.print("ReadMaxSpeed ");
  Serial.println(m1->ReadMaxSpeed);
  
  delay(2000);
    Serial.println("WriteSpeed backwards");
  m1->WriteSpeed(-255);
  delay(2000);
}
