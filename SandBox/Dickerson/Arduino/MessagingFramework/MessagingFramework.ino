...
void multiMessageToByteArrayTest()
{
  ...
  *m = new Message(0xA34E, 6, data2);
  ...
  byte data3[] = { 0x96, 0x69, 069, 0x96 };
  *m = new Message(0xF154, 4, data3);
  env->add(m);
  
  byte data4[] = { 0x69, 0x96, 096, 0x69 };
  *m = new Message(0xF154, 4, data4);
  env->add(m);
  
  byte expected[] = { 0x5E, 0x1F, 0x20, 0xA3, 0x4E, 0x06, 0xAA, 0x55, 0xF0, 0x0F, 0x00, 0xFF, 0xA3, 0x4E, 0x06, 0x55, 0xAA, 0x0F, 0xF0, 0xFF, 0x00, 0xF1, 0x54, 0x04, 0x96, 0x69, 069, 0x96, 0xF1, 0x54, 0x04, 0x69, 0x96, 096, 0x69, 0x88 };
  int expectedSize = 13;
